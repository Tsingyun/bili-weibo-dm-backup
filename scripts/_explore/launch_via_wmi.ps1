...
$cmdline = '"' + $exe + '" --user-data-dir="' + $profile + '" --remote-debugging-port=9333 --remote-allow-origins=http://127.0.0.1:9333,http://localhost:9333 --no-first-run --no-default-browser-check --disable-features=msEdgeSplashScreen about:blank'
