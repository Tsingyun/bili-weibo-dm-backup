...
| 19   | AI                        | 如：给[搜索AI助手测试版](https://space.bilibili.com/1000000001/)发送私信时对方的自动回复 |
    ...
    "session_list": [
      {
        ...
        "is_follow": 1,
        "is_dnd": 0,
        "ack_seqno": 1000000000000003,
        "ack_ts": 1000000000000004,
        "session_ts": 1000000000000005,
        "unread_count": 4,
        "last_msg": {
          "sender_uid": 100000000000002,
          "receiver_type": 1,
          "receiver_id": 100000006,
          "msg_type": 10,
          "content": "{\"title\":\"示例文本\",\"text\":\"示例文本2\",\"jump_text\":\"\",\"jump_uri\":\"\",\"modules\":null,\"jump_text_2\":\"\",\"jump_uri_2\":\"\",\"jump_text_3\":\"\",\"jump_uri_3\":\"\",\"notifier\":null,\"jump_uri_config\":{\"all_uri\":\"https://member.bilibili.com/york/flow-reward?navhide=1\\u0026from=msgrecall\",\"text\":\"\"},\"jump_uri_2_config\":{\"text\":\"\"},\"jump_uri_3_config\":{\"text\":\"\"},\"biz_content\":null}",
          "msg_seqno": 1000000000000007,
          "timestamp": 1000000008,
          "at_uids": null,
          "msg_key": 1000000000000000009,
          "msg_status": 0,
        ...
        "account_info": {
          "name": "示例文本3",
          "pic_url": "https://example.invalid/001.png"
        },
        "live_status": 0,
      ...
      },
      {
        ...
        "is_follow": 1,
        "is_dnd": 0,
        "ack_seqno": 1000000000000011,
        "ack_ts": 1000000000000012,
        "session_ts": 1000000000000013,
        "unread_count": 0,
        "last_msg": {
          "sender_uid": 100000010,
          "receiver_type": 1,
          "receiver_id": 100000006,
          "msg_type": 11,
          "content": "{\"title\":\"示例文本4\",\"times\":14,\"cover\":\"https://example.invalid/002.png\",\"rid\":1000000014,\"type_\":8,\"desc\":\"示例文本4\",\"bvid\":\"BV1000000015\",\"view\":452,\"danmaku\":0,\"pub_date\":1000000016,\"attach_msg\":null}",
          "msg_seqno": 1000000000000011,
          "timestamp": 1000000017,
          "at_uids": null,
          "msg_key": 1000000000000000018,
          "msg_status": 0,
          "notify_code": "",
          "new_face_version": 1,
          "msg_source": 6
      ...
      },
      {
        ...
        "group_cover": "https://example.invalid/003.jpg",
        "is_follow": 0,
        "is_dnd": 0,
        "ack_seqno": 20,
        "ack_ts": 1000000000000020,
        "session_ts": 1000000000000021,
        "unread_count": 0,
        "last_msg": {
          "sender_uid": 0,
          "receiver_type": 2,
          "receiver_id": 100000019,
          "msg_type": 306,
          "content": "{\"group_id\":100000019,\"content\":\"欢迎罗板栗入群\"}",
          "msg_seqno": 20,
          "timestamp": 1000000022,
          "at_uids": null,
          "msg_key": 1000000000000000023,
          "msg_status": 0,
          "notify_code": "",
          "msg_source": 13
        },
...
获取`begin_ts=1000000000000026`之后的新会话列表：

```shell
curl -G 'https://api.vc.bilibili.com/session_svr/v1/session_svr/new_sessions' \
  --data-urlencode 'begin_ts=1000000000000026' \
  --data-urlencode 'size=3' \
  --data-urlencode 'build=0' \
  --data-urlencode 'mobi_app=web' \
  -b 'SESSDATA=xxx'
...
若从未与该会话聊过天，则返回 1000027 `入口节点已存在` 错误
...
| 字段    | 类型 | 内容     | 备注                                                                           |
| ------- | ---- | -------- | ------------------------------------------------------------------------------ |
| code    | num  | 返回值   | 0：成功<br />-101：账号未登录<br />-400：请求错误<br />1000027：入口节点已存在 |
| msg     | str  | 错误信息 | 默认为0                                                                        |
| message | str  | 错误信息 | 默认为0                                                                        |
| ttl     | num  | 1        |                                                                                |
...
获取会话`talker_id=100000010&session_type=1`的详细信息：

```shell
curl -G 'https://api.vc.bilibili.com/session_svr/v1/session_svr/session_detail' \
  --data-urlencode 'talker_id=100000010' \
...
获取会话`uids=2`与`group_ids=100000019`的免打扰状态：

```shell
curl -G 'https://api.vc.bilibili.com/link_setting/v1/link_setting/get_msg_dnd' \
  --data-urlencode 'own_uid=100000006' \
  --data-urlencode 'uids=2' \
  --data-urlencode 'group_ids=100000019' \
  --data-urlencode 'build=0' \
  --data-urlencode 'mobi_app=web' \
  -b 'SESSDATA=xxx'
```
...
将`talker_id=100000010`、`session_type=1`的`ack_seqno=1000000000000011`消息及之前的消息设置为已读

```shell
curl 'https://api.vc.bilibili.com/session_svr/v1/session_svr/update_ack' \
  --data-urlencode 'talker_id=100000010' \
  --data-urlencode 'session_type=1' \
  --data-urlencode 'ack_seqno=1000000000000011' \
...
置顶会话`talker_id=100000010&session_type=1`
...
| min_seqno | num   | 所有消息中最小的序列号（最早） | 若无私信则为 `10000000000000000028` |
...
```json
{
  ...
  "data": {
    "messages": [
      {
        ...
        "msg_type": 1,
        "content": "{\"content\":\"[口罩]\"}",
        "msg_seqno": 100000000000030,
        "timestamp": 1000000031,
        "at_uids": [
          0
        ],
        "msg_key": 1000000000000000032,
        "msg_status": 0,
        "notify_code": "",
        "new_face_version": 1,
        "msg_source": 2
      },
      {
        ...
        "msg_type": 5,
        "content": "{\"content\":\"1\"}",
        "msg_seqno": 100000000000033,
        "timestamp": 1000000034,
        "at_uids": [
          0
        ],
        "msg_key": 1000000000000000035,
        "msg_status": 0,
        "notify_code": "",
        "msg_source": 7
    ...
    "has_more": 0,
    "min_seqno": 100000000000036,
    "max_seqno": 100000000000030,
    "e_infos": [
      {
        "text": "示例文本5",
        "url": "https://example.invalid/004.png",
        "size": 1
      }
    ]
  }
...
```json
{
  ...
  "data": {
    "archive": [
      {
        ...
        "aid": 170001,
        "title": "示例文本6",
        "pic": "https://example.invalid/005.jpg",
        "param": "170001",
    ...
    "pgc": [
      {
        "ep_id": 780019,
        "cover": "https://example.invalid/007.png",
        "title": "示例文本9",
        "duration": 7283,
        "view": 10000040,
        "danmaku": 93069,
...
以下为通用代码（来自 [andywang425/BLTH](https://github.com/andywang425/BLTH/blob/45fe93e31754ca8bf07059d10000041e787dbf45/B%E7%AB%99%E7%9B%B4%E6%92%AD%E9%97%B4%E6%8C%82%E6%9C%BA%E5%8A%A9%E6%89%8B.js#L6618)）：
...
curl 'https://api.vc.bilibili.com/web_im/v1/web_im/send_msg' \
  --data-urlencode 'msg[sender_uid]=100000010' \
  ...
  --data-urlencode 'msg[timestamp]=1000000042' \
...
```json
{
  ...
  "ttl": 1,
  "data": {
    "msg_key": 1000000000000000043,
    "e_infos": [
      {
        "text": "示例文本10",
        "url": "https://example.invalid/008.png",
        "size": 1
      }
    ],
...
> <img src="https://example.invalid/009.jpg" style="zoom: 50%;">
...
curl 'https://api.vc.bilibili.com/web_im/v1/web_im/send_msg' \
  ...
  --data-urlencode 'msg[dev_id]=372778FD-E359-461D-86A3-EA2BCC6FF52A' \
  --data-urlencode 'msg[timestamp]=1000000042' \
  --data-urlencode 'msg[content]={"url":"https://example.invalid/009.jpg","height":300,"width":300,"imageType":"jpeg","original":1,"size":54.144}' \
  --data-urlencode 'csrf=xxx' \
  --data-urlencode 'csrf_token=xxx' \
  -b 'SESSDATA=xxx'
```
