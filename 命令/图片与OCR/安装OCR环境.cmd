...
rem 版本锁在 scripts\requirements-ocr.txt —— 不锁的话上游被投毒会静默装进来，
rem 且 onnxruntime 新版已不支持本脚本固定使用的 Python 3.10。
"%ENV%\Scripts\python.exe" -m pip install --no-cache-dir ^
  -i https://pypi.tuna.tsinghua.edu.cn/simple ^
  -r "%ROOT%scripts\requirements-ocr.txt"
if errorlevel 1 (
  echo.
